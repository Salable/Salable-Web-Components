...
export class SalableStatus {
  ...
  getSvg() {
    if (this.statusType === StatusType.SUCCESS) {
      return (
        <svg id='success-svg' class='w-2.5 h-2.5' xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor'
             viewBox='0 0 16 16'>
          <path
    ...
    if (this.statusType === StatusType.WARNING) {
      return (
        <svg id='warning-svg' class='w-2.5 h-2.5' xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor'
             viewBox='0 0 16 16'>
          <path
    ...
    if (this.statusType === StatusType.ERROR) {
      return (
        <svg id='error-svg' class='w-2.5 h-2.5' xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor'
             viewBox='0 0 16 16'>
          <path
  ...
  render() {
    return (
      <Host>
        <span
          class={`inline-flex items-center gap-1.5 py-0.5 px-2 rounded-full text-xs font-medium dark:text-green-200 ${this.getColour()}`}>
            {this.getSvg()}
            <slot></slot>
        </span>
      </Host>
