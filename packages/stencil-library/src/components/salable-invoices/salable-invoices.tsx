...
export class SalableInvoices {
  ...
  render() {
    return (
      <Host>
        <div
          class='font-sans bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden dark:bg-slate-900 dark:border-gray-700'>
          {this.errorMessage && (
              ...
              {this.data?.data?.map(row => (
                <tr slot='table-body'>
                  <td class='h-px w-px whitespace-nowrap'>
                    <div class='px-6 py-2'>
                      <a class='text-sm text-primary-600 decoration-2 hover:underline dark:text-primary-500'
                  ...
                  <td class='h-px w-px whitespace-nowrap'>
                    <div class='px-6 py-2'>
                            <span class='text-sm text-gray-600 dark:text-gray-400 block w-full'>
                              <salable-date date={row.created * 1000}></salable-date></span>
                    </div>
                  </td>
                  <td class='h-px w-px whitespace-nowrap'>
                    <div class='px-6 py-2'>
